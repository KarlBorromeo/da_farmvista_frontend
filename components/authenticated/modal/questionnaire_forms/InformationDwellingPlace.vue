...
export default {
	...
	beforeMount() {
		this.houseOwernshipItems =
			this.$store.getters['questionnaireCode/Code6']
		this.typeRoofMadeItems =
			this.$store.getters['questionnaireCode/Code7_8']
		this.typeWallMadeItems =
			this.$store.getters['questionnaireCode/Code7_8']
		this.kindToiletItems = this.$store.getters['questionnaireCode/Code9']
		this.lightingFacilityItems =
			this.$store.getters['questionnaireCode/Code10']
		this.sourceCookingItems =
			this.$store.getters['questionnaireCode/Code11']
